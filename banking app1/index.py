...
button_image = Image.open("C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\blue-glossy-button1.jpg")
...
def registration_logic():
    ...
    file_path = "C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\user info\\" + accountNUM + ".txt"
    ...
    file_path = "C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\user info\\" + accountNUM + "_transaction_data.txt"
    if os.path.exists(file_path):
...
def login_logic():
    ...
    file_path = "C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\user info\\" + login_accountNUM + ".txt"
    if os.path.exists(file_path):
        account_exists = True
        with open(file_path, "r") as account_file:
            ...
            if login_password == stored_password:
                ...
                file_path = "C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\user info\\" + login_accountNUM + "_transaction_data.txt"
                if os.path.exists(file_path):
...
#Home image
img = Image.open('C:\\Users\\Nathan.Davids\\Desktop\\banking app1\\bank.jpg')
